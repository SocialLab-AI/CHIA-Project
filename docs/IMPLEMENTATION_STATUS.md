...
| E. Proxy calibration | PARTIAL | Issue #60 has exact GGUF inspection, native/original-proxy context sweeps, sensitivity cases and a Qwen-shaped pilot. The pilot exposed grouped-query mapping and head-dispatch defects. Canonical fixes, relative-error metrics and the corrected five-context sweep remain TODO; equivalent native hardware ranking is unavailable. |

## Verification

- Current branch verification: **111 tests passed, 1 environment-dependent test skipped and 2 scheduling tests deselected**. No failed tests.
