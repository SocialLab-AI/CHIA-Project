...
Stage 1 is one deterministic smoke candidate. Stage 2 is a three-candidate pilot per method. Use pilot wall time, disk use, failures, artifact size, and Gemini usage to set the approved burst budget.
