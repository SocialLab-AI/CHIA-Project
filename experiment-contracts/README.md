...
- `baselines/tutor.yaml`: Qwen and 250-question OpenStax-aligned team-assessment contract.
...
The team-assessment answer key is evaluator-only and never enters the model prompt. The committed production baseline contains no fabricated run metrics.
